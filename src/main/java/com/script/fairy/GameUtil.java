        ...
        new GameUtil(mFairy) {
            ...
            public void content_0() throws Exception {
                ...
                for (int i = 0; i < j; i++) {
                    ...
                    result1=mFairy.findPic(1031,4,1275,171,new String[]{"cha10.png","bxcha.png","bxcha1.png","fxcha.png"});
...
public int goCity(final String str) throws Exception {
    new GameUtil(mFairy) {
        ...
        public void content_3() throws Exception {
            ...
            if (result.sim > 0.8f) {
                mFairy.initMatTime();
                mFairy.onTap(0.8f, result, "前往炎居", 3000);
            }

            result = mFairy.findPic(339,93,686,205, new String[]{"fenxian.png","fenxian.png"});
            if (result.sim > 0.8f){
                mFairy.initMatTime();
