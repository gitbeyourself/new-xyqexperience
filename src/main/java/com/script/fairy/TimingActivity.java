...
public class TimingActivity extends TaskContent {
    ...
    FindResult result3;
    GameUtil gameUtil;
    boolean zchd = true, hejiu = true, ylwq = true, qllj = true, jiuyousan = true, ljp = true, ljp1 = true, xhyx = true, sjhd = true, sjjz = true, jzwz = true, jdp = true, bwzq = true;
    ...
    public int timingActivity() throws Exception {
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            //千里良驹 20:30-45
            if (AtFairyConfig.getOption("qllj").equals("1") && qllj && h == 20 && m < 45 && m > 29) {
                gameUtil.goCity("轩辕");
                paoma();
                paoma();
                qllj = false;
       ...
       /* //九幽界 12:15-45 18:15-45
        if (AtFairyConfig.getOption("jiuyousan").equals("1")&& jiuyousan  &&  (h==12 || h==18) && m>13 && m<45){
            ...
            //赛季活动
            if (AtFairyConfig.getOption("8781").equals("1") && sjhd && s > 36000 && s < 85800) {
                gameUtil.goCity("轩辕");
                zsld();
                sjhd = false;
                back = 1;
    ...
    public void sjhd() throws Exception {
        new TimingActivity(mFairy) {
            public void inOperation() throws Exception {
                super.inOperation();
                result = mFairy.findPic("hu1.png");
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(55, 127, 1197, 340, new String[]{"sfdz.png"});
                ...
                if (result.sim > 0.8f) {
                    mFairy.onTap(0.8f, result, "赛季活动", Sleep);
                    n = 0;
                    setTaskName(2);
                    return;
                }
            ...
            public void content_2() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    result1 = mFairy.findPic(545,522,772,656, "33.png");
                    if (result1.sim > 0.8f) {
                        LtLog.e("无奖励次数");
                        setTaskEnd();
                    } else {
                ...
                if (result.sim > 0.8f) {
                    ...
                    result = mFairy.findPic(35, 317, 260, 356, "sjhdjljs.png");
                    if (result.sim > 0.8f) {
                        LtLog.e(mFairy.getLineInfo("秘潜铸身中"));
    ...
    public void sjjz() throws Exception {
        new TimingActivity(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(492,517,515,541,"02.png");
                if (result.sim > 0.8f) {
                    LtLog.e("奖励次数无 退出");
                    setTaskEnd();
                }else{
    ...
    public void zsld() throws Exception {
        new TimingActivity(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(538,126,772,224,new String[]{"jljs.png","jljs1.png"});
                if (result.sim > 0.8f) {
                    LtLog.e("竞技结束");
                    mFairy.onTap(0.8f, result, 670,435,682,444,"结算确定", Sleep);
                    ...
                    if (result.sim > 0.8f) {
                        mFairy.onTap(0.8f, result,770,436,779,442, "退出战场", Sleep);
                    }
                    setTaskName(0);
                    return;
                }
...
//                    return;
                ...
                if (result2.sim > 0.8f) {
                    ...
                    result3 = mFairy.findPic(317,82,573,164, "duishou.png");
    ...
    public void jitian() throws Exception {
        new TimingActivity(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                LtLog.e(mFairy.getLineInfo(0.8f, result, "日常"));
                if (result.sim > 0.8f) result = mFairy.findPic(796,8,1115,157,new  String[]{"daily.png","fuli.png"});{
                    result = mFairy.findPic(699, 11, 1180, 264, new String[]{"bahuang1.png","bahuang.png","bh.png"});
                    if (result.sim > 0.8f) {
                        LtLog.e(mFairy.getLineInfo("有天外山海图标去天外据点战"));
                        setTaskName(2);
