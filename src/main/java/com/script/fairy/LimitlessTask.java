...
/*
            ...
            public void content_3() throws Exception {
                ...
                tu1 = 0;
                ceng1 = 0;
                if (AtFairyConfig.getOption("qxlb").equals("1")&& !LimitlessTask.this.sevenStar){
                    sevenStar();
                }
/*                if (yhsr == 121 || yhsr == 122 || yhsr == 123) {
                    result = mFairy.findPic(848,149,1122,240, "bahuang1.png");
                    mFairy.onTap(0.8f, result,  "八荒", 2000);

                    result = mFairy.findPic(1140,535,1274,662, "xysh.png");
                ...
                //查看当前的位置
                result = mFairy.findPic(1213,247,1265,496,new String[]{"hcWorld.png","hcWorld1.png","hcWorld2.png","hcWorld3.png"});
                if (result.sim > 0.8f) {
                    Thread.sleep(2000);
                    mFairy.condit();
                    ...
                    result = mFairy.findPic(1211,231,1271,484, new String[]{"hcWorld2.png","hcWorld3.png"});
                    if (result.sim > 0.8f) {
